...
namespace PayStack.Net
{
    public interface ITransfersApi
    {
        ...
        InitiateTransferResponse InitiateTransfer(int amount, string recipientCode, string source = "balance", string currency = "NGN", string reason = null, string reference = null);
